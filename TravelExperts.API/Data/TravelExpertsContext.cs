...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Agents>(entity =>
            {
                ...
                entity.Property(e => e.AgtBusPhone).HasMaxLength(75);

                entity.Property(e => e.AgtEmail).HasMaxLength(75);

                entity.Property(e => e.AgtFirstName).HasMaxLength(75);

                entity.Property(e => e.AgtLastName).HasMaxLength(75);

                entity.Property(e => e.AgtMiddleInitial).HasMaxLength(5);

                entity.Property(e => e.AgtPosition).HasMaxLength(75);
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustEmail)
                    .HasName("UQ__Customer__263FA28D9C3C0CB2")
                    .IsUnique();
